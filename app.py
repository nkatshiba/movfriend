...
st.set_page_config(page_title='movfriend' , page_icon=img , layout="centered",initial_sidebar_state="expanded")
...
hide_st_style = """
            ...
            footer:after{
                ...
                margin:1rem;
                padding:0.8rem;
                content:'Copyright © 2022 : movfriend';
                display: flex;
                align-items:center;
...
lottie_coding = load_lottieurl("https://assets6.lottiefiles.com/packages/lf20_qm8eqzse.json")
...
with st.sidebar:
    selected = option_menu(
                menu_title="movfriend",  # required
                options=["App", "About", "Github-Repo"],  # required
